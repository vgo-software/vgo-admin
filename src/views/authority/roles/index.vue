...
<script setup lang="tsx" name="roles">
...
import RoleFormDrawer from "@/views/authority/roles/FormDrawer.vue";
import SetMenuDrawer from "@/views/authority/roles/SetMenuDrawer.vue";
